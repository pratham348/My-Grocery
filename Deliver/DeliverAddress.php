...
<head>
    ...
    <title>My Grocery | Deliver Address</title>
 ...
 <div class="wrapper">
        ...
        <div id="content" class="bg-container">
            <header class="head">
              ...
              ?>
                                        <form action="db/dbDeliverAddress.php" method="post" class="form-horizontal login_validator" id="form_inline_validator">
<?php
             $id = $_SESSION['id'];
...
?>
<input type="hidden" name="AddId" value="<?php echo $data['deliver_id'];?>">
        ...
        ?>
                                            ...
                                            <div class="form-actions form-group row">
                                                <div class="col-xl-8 ml-auto">
                                                    <input type="submit" value="Register Address" name="RegAddress" class="btn btn-primary">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
