...
<head>
    <meta charset="UTF-8">
    <title>My Grocery | Completed Order</title>
    <?php
   ...
   <div class="wrapper">
        ...
        <div id="content" class="bg-container">
                        ...
                        <div class="col-12 data_tables">
                            ...
                            <div class="card">
                                <div class="card-header bg-white">
                                    <i class="fa fa-table"></i> Completed Order Table
                                </div>
              ...
              ?>                                    
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        ...
                                        <tr>
                                          ...
                                          <th>Dilivar Date Time</th>
                                          <th>Order Dispatch Status</th>
                                          <th>Order Dilivar Status</th>
                                          <th>Order Status</th>
                                          <th>Status</th>
                                          <th>Action</th>
                                        </tr>
                                        ...
                                        <tbody>
               <?php
              $q = "SELECT * FROM product_order WHERE dilivary_status=1 AND order_dilivar_status=1 AND order_dispatch_status=1 ";
            ...
            ?>
                                    ...
                                    <a href="RevertOrderStatus.php"> 
                                    <button class="btn btn-primary glow_button">Revert Order Status
                                                           </button></a>
