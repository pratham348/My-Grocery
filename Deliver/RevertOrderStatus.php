...
<head>
    <meta charset="UTF-8">
    <title>My Grocery | Revert Order Status</title>
    <?php
   ...
   <div class="wrapper">
        ...
        <div id="content" class="bg-container">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-t-25">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        ...
                                        <tbody>
               <?php
              $q = "SELECT * FROM product_order WHERE dilivary_status=1";
            ...
            ?>
                                    ...
                                    <input class="btn btn-primary glow_button" type="submit" name="complete_id" value="Revert Completed Order">
