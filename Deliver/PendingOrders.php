...
<head>
    <meta charset="UTF-8">
    <title>My Grocery | Pending Order</title>
    <?php
   ...
   <div class="wrapper">
        ...
        <div id="content" class="bg-container">
            ...
            ?>
                                    ...
                                    <a href="OrderStatusUpdate.php"> 
                                    <button class="btn btn-primary glow_button">Dispatch Order
                                                           </button></a>

                                    <a href="OrderStatusUpdate.php"> 
                                    <button class="btn btn-primary glow_button">Deliver Order
                                                           </button></a>
                                    <a href="OrderStatusUpdate.php"> 
