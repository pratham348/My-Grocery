...
?>
                	<!--Seller Sign Up-->
                     <form class="theme-form" method="POST" action="db/dbChangeCustomerAddress.php">
<?php
             $id = $_SESSION['id'];
...
?>
 ...
 <input type="hidden" name="customer" value="<?php echo $data['cust_id']; ?>">
                       
                        <div class="form-group">
                            <label>Address</label>
                            <textarea class="form-control"placeholder="Enter Full Address" required="" name="address"><?php echo $data['address']; ?></textarea>
        ...
        ?>
                        ...
                        <div class="form-group">
                        <input type="submit" name="CustomerUPD" class="btn btn-solid" value="Update Address" > 
                        </div>
