   ...
   <div class="wrapper">
    ...
    <div class="outer">
                        ...
                        <div class="col-12 data_tables">
                            <div class="card">
                                <div class="card-header bg-white">
                                    <i class="fa fa-table"></i> Complete Order
                                </div>
                                <div class="card-body m-t-35">
                                    <form method="POST" action="del&activeOrderDilivary.php">
            ...
            ?>
                                        ...
                                        <input class="btn btn-primary glow_button" type="submit" name="active_id" value="Complete Order">
                                    </form>
                                </div>
                            </div>
