        ...
        <div id="content" class="bg-container">
            ...
            <div class="outer">
                        ...
                        <div class="col-12 data_tables">
                            ...
                            <div class="card">
                                <div class="card-header bg-white">
                                    <i class="fa fa-table"></i> Seller Table
                                </div>
              ...
              <tr>
               ...
               <td><?php 
               $id=$result['seller_id'];
               $q1 = "SELECT * FROM seller_address WHERE seller_id='$id'";
              ...
              <!-- <td><a href="seller_edit.php?id=<?php echo $result['seller_id'];?>"class="btn btn-success btn-xs purple">
                <i class="fa fa-edit"></i>Edit</a>
               </td> -->
              <!-- <td><a href="seller_delete.php?id=<?php echo $result['seller_id'];?>"class="btn btn-info btn-xs black">
